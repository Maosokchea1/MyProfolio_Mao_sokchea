...
export default function Projects() {
    ...
    return (
        <section className="relative min-h-[70vh] bg-slate-950 text-white overflow-hidden">
            ...
            <div className="relative mx-auto max-w-6xl px-5 py-20 sm:px-8 md:py-28">
                ...
                <div className="flex flex-col items-center text-center">
                    <SectionTitle subtitle="Things I have designed and developed">
                ...
                {/* Projects Grid Area (Vertical Cards) */}
                {!loading && !error && (
                    <div className="mt-12">
